...
Chart helper functions for P2P profile display.

Extracted from p2p/chart.py for modularity.
"""
...
def setup_tooltip(ax, fig, d_km, distances, terrain_bulge, los_h, fresnel_r):
...
def make_save_png(fig, f_mhz, dist_m, dock):
...
def make_export_csv(distances, terrain_bulge, los_h, fresnel_r, f_mhz, dist_m, dock):
    from qgis.PyQt.QtWidgets import QFileDialog, QMessageBox
